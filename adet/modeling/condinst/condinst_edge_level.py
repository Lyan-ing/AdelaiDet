...
from .dynamic_mask_head_edge2 import build_dynamic_mask_head
from .mask_branch import build_mask_branch
import torchshow as ts
from adet.utils.comm import aligned_bilinear
from torchvision.utils import draw_bounding_boxes

__all__ = ["MyCondInst_Level_Edge_Depth"]
...
class MyCondInst_Level_Edge_Depth(nn.Module):
    """
    ...
    def forward(self, batched_inputs):
        ...
        if self.use_depth and self.training:
            ...
            # file_root = './we_test/10/' + file_name.split('.')[0]
    ...
    def add_bitmasks_from_boxes(self, instances, images, image_mask, im_h, im_w, depth_prediction=None):
