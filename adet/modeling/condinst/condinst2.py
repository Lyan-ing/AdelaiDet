...
from .dynamic_mask_head2 import build_dynamic_mask_head
from .mask_branch import build_mask_branch

from adet.utils.comm import aligned_bilinear
from my_depth import MyDPT
...
class MyCondInst(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.depth = MyDPT("/home/yl/python/AdelaiDet1/weights/dpt_hybrid-midas-501f0c75.pt", 384, 384, self.device)
    ...
    def forward(self, batched_inputs):
        ...
        downsampled_images = F.avg_pool2d(
            images_norm.tensor.float(), kernel_size=2,
            stride=2, padding=0
        )[:, [2, 1, 0]]
        depth_prediction = self.depth.compute_depth(downsampled_images)  # 尺寸先变一下，再处理可以减少上下采样的消耗，在此获得图像尺寸
