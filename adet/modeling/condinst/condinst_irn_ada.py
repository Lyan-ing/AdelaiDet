...
from .dynamic_mask_head_irn_ada import build_dynamic_mask_head
...
class MyCondInst_IRN_Ada(nn.Module):
    """
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            if self.pred_depth:
                depth_pred_loss = {}
                depth_pred = aligned_bilinear(depth_pred.sigmoid(), 2)
