...
from .dynamic_mask_head_emb import build_dynamic_mask_head
...
class MyCondInst_Emb(nn.Module):
    """
        ...
        for im_i, per_im_gt_inst in enumerate(instances):
            ...
            if depth_prediction is not None:
                ...
                per_im_gt_inst.depth_edge = torch.cat([
                    depth_edge[None] for _ in range(len(per_im_gt_inst))
                ], dim=0)
