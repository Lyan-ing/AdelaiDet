...
class MyCondInst_Dis(nn.Module):
    """
    ...
    def forward(self, batched_inputs, branch='student'):
        ...
        if self.training and branch == 'student':
            ...
            for proposal, mask_feat in zip(proposals, mask_feats):
                ...
                instances_per_im = self.postprocess(
                    instances_per_im, padded_im_h, padded_im_w,
                    padded_im_h, padded_im_w, branch = 'teacher'
                )
    ...
    def postprocess(self, results, output_height, output_width, padded_im_h, padded_im_w, mask_threshold=0.5, branch='infer'):
        """
