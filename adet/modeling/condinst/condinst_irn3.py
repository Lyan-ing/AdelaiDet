...
from .dynamic_mask_head_irn import build_dynamic_mask_head
from .mask_branch_catdepth import build_mask_branch
from adet.utils.comm import aligned_bilinear

__all__ = ["MyCondInst_IRN_Cat"]
...
class MyCondInst_IRN_Cat(nn.Module):
    """
    ...
    def __init__(self, cfg):
        ...
        if self.pred_depth:
            self.controller = nn.Conv2d(
                in_channels + 1, self.mask_head.num_gen_params,
    ...
    def forward(self, batched_inputs):
        ...
        proposals, proposal_losses = self.proposal_generator(
            images_norm, features, gt_instances, self.controller, depth_pred
        )  # fcos
