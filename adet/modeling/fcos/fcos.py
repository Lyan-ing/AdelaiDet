...
class FCOS(nn.Module):
    ...
    def forward(self, images, features, gt_instances=None, top_module=None, branch = 'student'):
        """
        Arguments:
        ...
        """
        features = [features[f] for f in self.in_features]
        locations = self.compute_locations(features)  # locations of different feature points
        ...
        # top module is controller-->fcos head
        ...
        if self.training and branch == 'student':
            ...
            return results, losses  # proposals, proposal_losses
        else:
...
class FCOSHead(nn.Module):
    ...
    def forward(self, x, top_module=None, yield_bbox_towers=False):
        ...
        for l, feature in enumerate(x):
            ...
            bbox_tower = self.bbox_tower(feature)  # p3-p7每层feature
            if yield_bbox_towers:  # no
        ...
        return logits, bbox_reg, ctrness, top_feats, bbox_towers  # top feature is the weight of dynamic mask head
        #       classes80, box4, centerness1, dynamic weights233, ?