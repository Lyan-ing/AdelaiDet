...
class Trainer(DefaultTrainer):
    ...
    def compute_iou_with_each_box(self, true_boxes, pred_boxes, pred_scores, mask_score_with_depth_sim, semi_rate):
        ...
        ggiou = (self.threshold[1] + semi_rate) * ggiou + (1-(self.threshold[1] + semi_rate)) * mask_score_with_depth_sim
    ...
    def merge_pseudo_label(self, ori_data, teacher_prediction, depth_sims, semi_rate):
        ...
        #                                                                  mask_feature_attention, depth_sims):
            ...
            match_idx, match_score = self.compute_iou_with_each_box(true_box, pred_box, pred_scores.cpu(), mask_score_with_depth_sim.cpu(), semi_rate)
    ...
    def run_step_full_semisup(self):
        ...
        if self.iter < self.cfg.MODEL.BOXINST.SEMSUPER:  # 在此处,  data aug for different models(teacher and student)
            ...
            data_strong = self.merge_pseudo_label(data_strong, teacher_prediction, depth_sims, semi_rate)
