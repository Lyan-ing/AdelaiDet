...
class Trainer(DefaultTrainer):
    ...
    def merge_pseudo_label(self, ori_data, teacher_prediction, mask_feature_attention):
        ...
        for single_data, single_pred, mask_feature in zip(ori_data, teacher_prediction, mask_feature_attention):
    ...
    def run_step_full_semisup(self):
        ...
        if self.iter < self.cfg.MODEL.BOXINST.SEMSUPER:  # 在此处,  data aug for different models(teacher and student)
            ...
            with torch.no_grad():
                (teacher_prediction, mask_feature_attention, ) = self.model_teacher(data, branch="teacher")
